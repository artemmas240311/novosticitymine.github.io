<!doctype html>
<html lang="en-US">
<title>-новасти CITYMINE</title>
<meta charset="utf-8">
<meta name="description" content="CITYMINE ЭТО сервер в майнкрафт каждый хочет играть с другом на сервере вы его нашли.">
...
<meta name="author" content="новасти CITYMINE">
<meta name="copyright" content="новасти CITYMINE">
...
<body>
<img src="https://youtu.be/TYZCSPB8Ipw" width="1" height="1" alt="Preload"/>
<img src="https://youtu.be/beXEmuJhVoA" width="1" height="1" alt="Preload"/>
<img src="https://youtu.be/beXEmuJhVoA" width="1" height="1" alt="Preload"/>
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 CITYMINE ЭТО сервер в майнкрафт.Каждый хочет играть с другом на сервере вы его нашли.
							</p>
				...
				<div class="search-con-inner">
					<div class="search-inp-search darkmode-search-border">
						...
						<form action='/compatibility' method='get'>
							<input class="database-search darkmode-txt darkmode-search-bg" name="g" placeholder="как дела">
						</form>
					</div>
				</div>
			</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 сегодня удалилось более 5 городов это не самое плахое на сегодня.
								</p>
							</div>
							<a href="https://discord.gg/J8ntfXuH" target="_blank">
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									 сегодня лукоморье может пропасть это пичально и ещё пичально то что сити майн лагает.
								</p>
							</div>
							<a target="_blank">
					...
					<div class="patreon-con-mantra">
						<div class="patreon-wrp-mantra scale-content-txt-1 ">
							...
							<div class="patreon-tx2-mantra darkmode-txt">
								<p>
									 подержка автора https://www.donationalerts.com/r/artem_maslikov и подпишитесь на него парень старался.
								</p>
							</div>
							<a href="https://youtu.be/TYZCSPB8Ipw" target="_blank">
